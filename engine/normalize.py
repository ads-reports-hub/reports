...
# Приводим к тому же виду, что был в ручном июньском отчёте: "VIP · IG direct · 14.5".
    ...
    for row in campaigns_raw.get("data", []):
        ...
        for i, ad_row in enumerate(ads_by_campaign.get(raw_name, []), start=1):
            ...
            ads.append({
                ...
                "audience_ru": ad_audience,
                "audience_en": ad_audience,
        ...
        campaigns.append({
            "name": _clean_campaign_name(raw_name),
            "date": "",
            "goal_ru": goal_ru,
            "goal_en": goal_en,
            "reach": totals["reach"],
            ...
            "audience": _strip_em_dash(audience),
            "ads": ads,
        })
    return campaigns
